...
public class CBCExplosion {
	...
	public CBCExplosion(World par1World, Entity par2Entity, double par3,
		...
		this.explosion = new Explosion(par1World, par2Entity, par3, par5, par7,
				par9);
	}
	...
	public EntityLiving func_94613_c() {
		return this.exploder == null ? null
				: (this.exploder instanceof EntityTNTPrimed ? ((EntityTNTPrimed) this.exploder)
						.getTntPlacedBy()
						: (this.exploder instanceof EntityLiving ? (EntityLiving) this.exploder
								: null));
	}
}
