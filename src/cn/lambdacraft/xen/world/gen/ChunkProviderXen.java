...
import cn.lambdacraft.xen.event.CBCInitNoiseGensEvent;
import cn.lambdacraft.xen.register.XENBlocks;
import cn.lambdacraft.xen.world.gen.NoiseGeneratorXen;
...
public class ChunkProviderXen implements IChunkProvider {
	...
	private NoiseGeneratorXen xenNoiseGen1;
	private NoiseGeneratorXen xenNoiseGen2;
	private NoiseGeneratorXen xenNoiseGen3;
	...
	public ChunkProviderXen(World par1World, long par2) {
		...
		this.xenNoiseGen1 = new NoiseGeneratorXen(this.xenRNG, 16);
		this.xenNoiseGen2 = new NoiseGeneratorXen(this.xenRNG, 16);
		this.xenNoiseGen3 = new NoiseGeneratorXen(this.xenRNG, 8);

		NoiseGeneratorXen[] noiseGens = { xenNoiseGen1, xenNoiseGen2, xenNoiseGen3, };
		noiseGens = this.getModdedNoiseGenerators(par1World, this.xenRNG, noiseGens);

		this.xenNoiseGen1 = noiseGens[0];
		this.xenNoiseGen2 = noiseGens[1];
		this.xenNoiseGen3 = noiseGens[2];

	}

    public NoiseGeneratorXen[] getModdedNoiseGenerators(World world, Random rand, NoiseGeneratorXen[] original)
    {
        CBCInitNoiseGensEvent event = new CBCInitNoiseGensEvent(world, rand, original);
	...
	private double[] initializeNoiseField(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6, int par7) {
		...
		this.noiseData4 = this.xenNoiseGen1.generateNoiseXens(this.noiseData4, par2, par3, par4, par5, 1, par7, 1.0D, 0.0D, 1.0D);
		this.noiseData5 = this.xenNoiseGen2.generateNoiseXens(this.noiseData5, par2, par3, par4, par5, 1, par7, 100.0D, 0.0D, 100.0D);
		this.noiseData1 = this.xenNoiseGen3.generateNoiseXens(this.noiseData1, par2, par3, par4, par5, par6, par7, d0 / 80.0D, d1 / 60.0D, d0 / 80.0D);
		this.noiseData2 = this.xenNoiseGen1.generateNoiseXens(this.noiseData2, par2, par3, par4, par5, par6, par7, d0, d1, d0);
		this.noiseData3 = this.xenNoiseGen2.generateNoiseXens(this.noiseData3, par2, par3, par4, par5, par6, par7, d0, d1, d0);
		int k1 = 0;
		int l1 = 0;
