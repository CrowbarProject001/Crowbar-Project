...
public class RenderTrail extends Render {
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        for(int i = 0; i < list.size() - 1; i++){
        	...
        	else loadTexture(ent.getTexNormal());
        	
        	SamplePoint sp1 = list.get(i), sp2 = list.get(i + 1);
   	
        	Vec3 v1 = getVec3(0, 0, -width).addVector(sp1.x, sp1.y, sp1.z),
        			v2 = getVec3(0, 0, width).addVector(sp1.x, sp1.y, sp1.z),
        			v3 = getVec3(0, 0, width).addVector(sp2.x, sp2.y, sp2.z),
        			v4 = getVec3(0, 0, -width).addVector(sp2.x, sp2.y, sp2.z);
        	
        	Vec3 v5 = getVec3(-width, 0, 0).addVector(sp1.x, sp1.y, sp1.z),
        			v6 = getVec3(width, 0, 0).addVector(sp1.x, sp1.y, sp1.z),
        			v7 = getVec3(width, 0, 0).addVector(sp2.x, sp2.y, sp2.z),
        			v8 = getVec3(-width, 0, 0).addVector(sp2.x, sp2.y, sp2.z);
        	
        	Vec3 v9 = getVec3(0, -width, 0).addVector(sp1.x, sp1.y, sp1.z),
        			v10 = getVec3(0, width, 0).addVector(sp1.x, sp1.y, sp1.z),
        			v11 = getVec3(0, width, 0).addVector(sp2.x, sp2.y, sp2.z),
        			v12 = getVec3(0, -width, 0).addVector(sp2.x, sp2.y, sp2.z);
