...
public class GaussBulletManager {
	...
	public static void Shoot(ItemStack itemStack, EntityLiving entityPlayer,
			World worldObj) {
		worldObj.spawnEntityInWorld(new EntityBulletGauss(worldObj,
	...
	public static void Shoot2(EnumGaussRayType typeOfRay, World worldObj,
		...
		worldObj.spawnEntityInWorld(new EntityBulletGaussSec(typeOfRay,
				worldObj, entityPlayer, itemStack, result, motion, damage));
	}

	public static Boolean doBlockCollision(EntityLiving player,
