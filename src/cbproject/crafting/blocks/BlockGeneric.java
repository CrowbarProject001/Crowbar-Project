...
public class BlockGeneric extends BlockContainer {
	...
	public Icon iconSide, iconTop, iconMain;

	public enum GenericIconType {
		PRODUCE, NOMATERIAL, NONE;
	}

	public BlockGeneric(int id) {
		super(id, Material.iron);
		setCreativeTab(CBCMod.cct);
		setUnlocalizedName("generic");
	}
	...
	public void registerIcons(IconRegister par1IconRegister) {
		iconSide = par1IconRegister.registerIcon("lambdacraft:generic_side");
		iconTop = par1IconRegister.registerIcon("lambdacraft:generic_top");
		iconMain = par1IconRegister.registerIcon("lambdacraft:generic_main");
		blockIcon = iconTop;
	}
	...
	public void randomDisplayTick(World par1World, int par2, int par3,
		...
		TileEntityGeneric te = (TileEntityGeneric) par1World
	...
	private void dropItems(World world, int x, int y, int z) {
		...
		TileEntityGeneric inventory = (TileEntityGeneric) tileEntity;
