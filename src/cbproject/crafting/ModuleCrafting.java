 ...
 *
 */
@Mod(modid="lcwrld",name="LambdaCraft|World",version="1.0.0.05")
...
public class ModuleCrafting {
	...
	public void init(FMLInitializationEvent Init){
		...
		CBCGuiHandler.addGuiElement(GeneralProps.GUI_ID_EL_CRAFTER, new CRGuiElements.ElementElCrafter());
	...
	public void postInit(FMLPostInitializationEvent Init){
		...
		RecipeCrafter wpnRecipes[] = {
				...
				new RecipeCrafter(new ItemStack(DMItems.weapon_satchel, 15), 3500, CBCItems.materials.newStack(3, EnumMaterial.LIGHT), CBCItems.materials.newStack(1, EnumMaterial.TECH), CBCItems.materials.newStack(6, EnumMaterial.EXPLOSIVE)),
				new RecipeCrafter(new ItemStack(DMItems.weapon_gauss), 4800, CBCItems.materials.newStack(8, EnumMaterial.LIGHT), CBCItems.materials.newStack(3, EnumMaterial.TECH), new ItemStack(Block.glass, 5)),
				new RecipeCrafter(new ItemStack(DMItems.weapon_egon), 5600, CBCItems.materials.newStack(5, EnumMaterial.HEAVY), CBCItems.materials.newStack(3, EnumMaterial.ACCESSORIES), CBCItems.materials.newStack(4, EnumMaterial.TECH)),
				new RecipeCrafter(new ItemStack(DMItems.weapon_crossbow), 3000, CBCItems.materials.newStack(6, EnumMaterial.LIGHT) ,CBCItems.materials.newStack(3, EnumMaterial.ACCESSORIES), new ItemStack(CBCItems.ironBar, 2)),
				new RecipeCrafter(new ItemStack(DMItems.weapon_hornet), 3000, CBCItems.materials.newStack(4, EnumMaterial.BIO), CBCItems.materials.newStack(3, EnumMaterial.ACCESSORIES)),
		...
		//电力合成机独有 装备合成表
		armors[] = {
				new RecipeCrafter(new ItemStack(DMItems.armorHEVBoot), 6000, CBCItems.materials.newStack(3, EnumMaterial.TECH), CBCItems.materials.newStack(6, EnumMaterial.LIGHT), CBCItems.materials.newStack(3, EnumMaterial.ARMOR)),
				new RecipeCrafter(new ItemStack(DMItems.armorHEVLeggings), 6000, CBCItems.materials.newStack(3, EnumMaterial.TECH), CBCItems.materials.newStack(6, EnumMaterial.LIGHT), CBCItems.materials.newStack(3, EnumMaterial.ARMOR)),
				new RecipeCrafter(new ItemStack(DMItems.armorHEVChestplate), 7000, CBCItems.materials.newStack(4, EnumMaterial.TECH), CBCItems.materials.newStack(7, EnumMaterial.LIGHT), CBCItems.materials.newStack(4, EnumMaterial.ARMOR)),
				new RecipeCrafter(new ItemStack(DMItems.armorHEVHelmet), 6000, CBCItems.materials.newStack(2, EnumMaterial.TECH), CBCItems.materials.newStack(4, EnumMaterial.LIGHT), CBCItems.materials.newStack(2, EnumMaterial.ARMOR)),
				new RecipeCrafter(new ItemStack(DMItems.longjump), 3000, CBCItems.materials.newStack(2, EnumMaterial.TECH), CBCItems.materials.newStack(2, EnumMaterial.ARMOR)),
