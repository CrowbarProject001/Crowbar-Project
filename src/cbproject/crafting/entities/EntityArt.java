 ...
 * 
 */
public class EntityArt extends Entity {
	...
	// 被框架自动调用
	public EntityArt(World world) {
		super(world);
		this.setSize(1.0F, 1.0F);
	}

	// 被 Item 调用
	public EntityArt(World world, int x, int y, int z, int direction,
			int title_id) {
		this(world);
	...
	public boolean onValidSurface() {
		...
		// System.out.println("位置：" + x + "," + y + "," + z + " 方向：" +
		// direction);
		...
		for (Object entity : list) {
			if (!(entity instanceof EntityArt))
				continue;
	...
	public void dropItemStack() {
		this.entityDropItem(new ItemStack(CBCItems.itemArt), 0.0F);
	}
