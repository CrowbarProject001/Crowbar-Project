...
public abstract class WeaponGeneralBullet extends Item {
	...
	public String pathSoundShoot,pathSoundJam;
	...
	public WeaponGeneralBullet(int par1 , int par2ammoID, int par3ReloadTime, int par4ShootTime[], String par6Shoot, String par7Jam) {
		super(par1);
		ammoID = par2ammoID;
		
		reloadTime = par3ReloadTime;
		shootTime = par4ShootTime;
		pathSoundShoot = par6Shoot;
		pathSoundJam = par7Jam;
    ...
    public void onBulletWpnUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
		...
		if( information.signID != par1ItemStack.getTagCompound().getDouble("uniqueID") || information == null){
			System.err.println("Information not match,quitting...");
		}
