...
public class CBCExplosion {
    ...
    public CBCExplosion(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9)
    {
    ...
    public CBCExplosion setVelocityFactor(double f){
    	velocityFactor = f;
    	return this;
    }
    
    public CBCExplosion setSoundFactor(float f){
    	soundFactor = f;
    	return this;
    }
                    ...
                    if (i == 0 || i == this.field_77289_h - 1 || j == 0 || j == this.field_77289_h - 1 || k == 0 || k == this.field_77289_h - 1)
                    {
                        ...
                        for (float f2 = 0.3F; f1 > 0.0F; f1 -= f2 * 0.75F)
                        {
                            ...
                            if (k1 > 0)
                            {
                                ...
                                float f3 = this.exploder != null ? this.exploder.func_82146_a(explosion, this.worldObj, l, i1, j1, block) : block.getExplosionResistance(this.exploder, worldObj, l, i1, j1, explosionX, explosionY, explosionZ);
                                f1 -= (f3 + 0.3F) * f2;
                            }

                            if (f1 > 0.0F && (this.exploder == null || this.exploder.func_96091_a(explosion, this.worldObj, l, i1, j1, k1, f1)))
                            {
    ...
    {
        this.worldObj.playSoundEffect(this.explosionX, this.explosionY, this.explosionZ, "random.explode", explosionSize * soundFactor, (1.0F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2F) * 0.7F);
